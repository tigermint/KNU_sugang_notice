...
def scrolling(driver):
    #mockcha = ['개설연도', '개설학기', '학년', '교과구분', '개설대학',
    #  '개설학과', '강좌번호', '교과목명', '학점', '강의', 
    # '실습', '담당교수', '강의시간', '강의시간(실제시간)', '강의실', 
    # '호실번호', '수강정원', '수강신청', '수강꾸러미신청', '수강꾸러미신청가능여부', 
    # '강의방식', '비고']
...
def searching(lecturename): #강의명 받아와서 검색하기
    ...
    # driver = web.Chrome(executable_path='./chromedriver', options = op) # in ubuntu
